Attribute VB_Name = "FINAL_SEPARATOR_v2"
Sub SplitByIDPHAcrossSheetsWithFolderSelection()
    ...
    For Each ID In uniqueIDs
        ...
        ' Zmiana nazwy domyœlnego arkusza na "Podsumowanie Wynagrodzenia"
        newWorkbook.Sheets(1).Name = "Podsumowanie Wynagrodzenia"
        ...
        ' Przenoszenie arkusza "Podsumowanie Wynagrodzenia" na pierwsze miejsce
        newWorkbook.Sheets("Podsumowanie Wynagrodzenia").Move Before:=newWorkbook.Sheets(1)
